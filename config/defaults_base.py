...
_C.TRAIN.STAGE1.MAX_EPOCHS = 100
_C.TRAIN.STAGE1.WARMUP_EPOCHS = 10
...
_C.TRAIN.STAGE1.SCHEDULER.NAME = 'warm_cosine'
# scheduler(optimizer, **params)
_C.TRAIN.STAGE1.SCHEDULER.PARAMS = None
# Optimizer
...
_C.TRAIN.STAGE2.SCHEDULER.NAME = 'warm_cosine'
# scheduler(optimizer, **params)
_C.TRAIN.STAGE2.SCHEDULER.PARAMS = None
# Optimizer
